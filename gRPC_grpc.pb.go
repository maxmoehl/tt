...
type TtClient interface {
	StartTimer(ctx context.Context, in *StartParameters, opts ...grpc.CallOption) (*GRpcTimer, error)
	StopTimer(ctx context.Context, in *StopParameters, opts ...grpc.CallOption) (*GRpcTimer, error)
	ResumeTimer(ctx context.Context, in *ResumeParameters, opts ...grpc.CallOption) (*GRpcTimer, error)
}
...
func (c *ttClient) StartTimer(ctx context.Context, in *StartParameters, opts ...grpc.CallOption) (*GRpcTimer, error) {
	out := new(GRpcTimer)
...
func (c *ttClient) StopTimer(ctx context.Context, in *StopParameters, opts ...grpc.CallOption) (*GRpcTimer, error) {
	out := new(GRpcTimer)
...
func (c *ttClient) ResumeTimer(ctx context.Context, in *ResumeParameters, opts ...grpc.CallOption) (*GRpcTimer, error) {
	out := new(GRpcTimer)
...
type TtServer interface {
	StartTimer(context.Context, *StartParameters) (*GRpcTimer, error)
	StopTimer(context.Context, *StopParameters) (*GRpcTimer, error)
	ResumeTimer(context.Context, *ResumeParameters) (*GRpcTimer, error)
...
func (UnimplementedTtServer) StartTimer(context.Context, *StartParameters) (*GRpcTimer, error) {
	return nil, status.Errorf(codes.Unimplemented, "method StartTimer not implemented")
}
func (UnimplementedTtServer) StopTimer(context.Context, *StopParameters) (*GRpcTimer, error) {
	return nil, status.Errorf(codes.Unimplemented, "method StopTimer not implemented")
}
func (UnimplementedTtServer) ResumeTimer(context.Context, *ResumeParameters) (*GRpcTimer, error) {
